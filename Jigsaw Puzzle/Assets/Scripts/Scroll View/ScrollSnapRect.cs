...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    private void SetPagePositions() {
        ...
        if (_horizontal) {
            ...
            width = (int)_scrollRectRect.rect.width * CommonUltilities.GetRescaleRatio();
        ...
        for (int i = 0; i < _pageCount; i++) {
            ...
            child.sizeDelta = new Vector2(child.rect.width * CommonUltilities.GetRescaleRatio(), child.rect.height);
